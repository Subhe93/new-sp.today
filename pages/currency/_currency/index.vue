      ...
      <v-col md="8" cols="12" class="text-start">
        <v-row>
          <v-col cols="12">
            ...
            <CurrencyContent
              :currencyName="
                this.$store.state.currency_prices.all[0].dest_currency_translations[0]
                  .name
              "
...
export default {
  ...
  head() {
    ...
    const metaData = {
      title: this.$t("currency.metaTitle.general", {
        currency: this.$store.state.currency_prices.all[0].dest_currency_translations[0]
          .name,
      }),
      description: this.$t("currency.metaDescription.general", {
        currency: this.$store.state.currency_prices.all[0].dest_currency_translations[0]
          .name,
      }),
    };
